...
\begin{frame}{GMP}{Где используют?}
  \begin{enumerate}
    \item OpenSSL и libgcrypt используют GMP для реализации криптографии \pause
    \item Mathematica (система компьютерной алгебры)\pause
...
\begin{frame}
  \begin{center}
    {\usebeamercolor[fg] \Huge Демонстрация}
  \end{center}
\end{frame}
